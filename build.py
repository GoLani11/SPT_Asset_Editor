...
APP_VERSION = "1.0.0"  # <<--- 버전 정보 정의 (이곳만 수정하면 됩니다)
...
def create_version_py(version_str):
    ...
    version_py_content = f"# Automatically generated by build.py\n__version__ = \"{version_str}\"\n"
...
pyinstaller_cmd = [
    ...
    "--hidden-import", "UnityPy.resources", # UnityPy 리소스 모듈 명시적 포함
    "--hidden-import", "UnityPy.helpers",   # UnityPy 하위 모듈
    "--hidden-import", "UnityPy.streams",
    "--hidden-import", "UnityPy.files",
    "--hidden-import", "UnityPy.enums",
    "--hidden-import", "UnityPy.export",    # UnityPy 내보내기 모듈 추가
    "--hidden-import", "UnityPy.export.Texture2DConverter", # 텍스처 변환 모듈
    "--hidden-import", "astc_encoder",      # ASTC 텍스처 디코딩 모듈
    "--hidden-import", "astc_encoder.encoder", # ASTC 인코더 서브모듈
    "--hidden-import", "archspec",          # CPU 아키텍처 감지 모듈
    "--hidden-import", "archspec.cpu",
    "--hidden-import", "archspec.cpu.detect",
    "--hidden-import", "archspec.cpu.microarchitecture",
    # "--icon", ICON_FILE, # 아이콘 설정은 아래에서 파일 존재 확인 후 추가
    ...
    # "--log-level=DEBUG", # 빌드 문제 발생 시 주석 해제하여 디버그 로그 확인
]
...
try:
    ...
    print(f"실행 파일은 '{os.path.abspath(DIST_PATH)}' 폴더에서 확인할 수 있습니다.")
    print("-" * 30)
